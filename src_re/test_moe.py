...
if __name__ == "__main__":
    ...
    moe.load_state_dict(torch.load("saved_models/MoEs/moe_cartpole_mlp.pt"))
    moe.eval()
    ...
    for _ in range(num_episodes):
        ...
        while not done:
            ...
            param_recon = torch.squeeze(param_sub_all[:, :n_dom_modes] @ weights.unsqueeze(1))
            nn.utils.vector_to_parameters(param_recon, policy_net.parameters())
    ...
    print("GIF saved as imgs/cartpole_mlp_reconstruct_moe.gif")